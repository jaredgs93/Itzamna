...
def myspsyl(m,p):
    ...
    try:
        ...
        z3=0
        print ("Try again1 the sound of the audio was not clear")
    return; 
...
def mysppaus(m,p):
    ...
    try:
        ...
        z3=0
        print ("Try again2 the sound of the audio was not clear")
    return; 
...
def myspsr(m,p):
    ...
    try:
        ...
        z3=0
        print ("Try again3 the sound of the audio was not clear")
    return;
...
def myspatc(m,p):
    ...
    try:
        ...
        z3=0
        print ("Try again4 the sound of the audio was not clear")
    return;
...
def myspst(m,p):
    ...
    try:
        ...
        z4=0
        print ("Try again5 the sound of the audio was not clear")
    return;
...
def myspod(m,p):
    ...
    try:
        ...
        z4=0
        print ("Try again6 the sound of the audio was not clear")
    return;
...
def myspbala(m,p):
    ...
    try:
        ...
        z4=0
        print ("Try again7 the sound of the audio was not clear")
    return;
...
def myspf0mean(m,p):
    ...
    try:
        ...
        z4=0
        print ("Try again8 the sound of the audio was not clear")
    return;
...
def myspf0sd(m,p):
    ...
    try:
        ...
        z4=0
        print ("Try again9 the sound of the audio was not clear")
    return;
...
def myspf0med(m,p):
    ...
    try:
        ...
        z4=0
        print ("Try again10 the sound of the audio was not clear")
    return;
...
def myspf0min(m,p):
    ...
    try:
        ...
        z3=0
        print ("Try again11 the sound of the audio was not clear") 
    return;
...
def myspf0max(m,p):
    ...
    try:
        ...
        z3=0
        print ("Try again12 the sound of the audio was not clear")
    return;
...
def myspf0q25(m,p):
    ...
    try:
        ...
        z3=0
        print ("Try again13 the sound of the audio was not clear")
    return;
...
def myspf0q75(m,p):
    ...
    try:
        ...
        z3=0
        print ("Try again14 the sound of the audio was not clear")
    return;
...
def mysptotal(m,p):
    ...
    sourcerun=p+"/"+"dataset"+"/"+"essen"+"/"+"myspsolution.praat"
    path=p+"/"+"dataset"+"/"+"audioFiles"+"/"
    print("Sonido", os.path.exists(sound))
    print("Praat", os.path.exists(sourcerun))
    print("Ruta", os.path.exists(path))
    ...
    try:
        ...
        z5=z4.T
        dataset=pd.DataFrame({"num_pausas":z5[1,:], "articulacion":z5[3,:], "rate_of_speech":z5[2,:], "balance":z5[6,:],
                              "f0_mean":z5[7,:],"f0_std":z5[8,:],"f0_median":z5[9,:],"f0_min":z5[10,:],"f0_max":z5[11,:],
                              "f0_quantile25":z5[12,:],"f0_quan75":z5[13,:], 
                              "number_ of_syllables":z5[0,:],"speaking_duration":z5[4,:],
...
def mysppron(m,p):
    ...
    try:
        ...
        print ("Try again15 the sound of the audio was not clear")
    return;
...
def myspgend(m,p):
    ...
    try:
        ...
        if z4>94 and z4<=114:
            ...
            mood_value="Showing no emotion, normal"
        elif z4>114 and z4<=135:
            ...
            mood_value="Speaking passionately"
        elif z4>163 and z4<=197:
        ...
        print ("Try again16 the sound of the audio was not clear")
    print("De esto depende el mood",z4)
    return mood_value
...
def mysplev(m,p):
	...
	bi=myspp(bp,bg)
	if bi<85:
		input("Try again17, unnatural-sounding speech detected. No further result. Press any key to exit.")
		exit()
